...
# ==========================================
# CONFIGURAÇÃO EDITORIAL - MD ARTE FOTO
# ==========================================

# Quantos dias devem passar para repetir o mesmo tema
DIAS_REPETICAO_TEMA = 120

# Quantos dias devem passar para repetir o mesmo módulo
DIAS_REPETICAO_MODULO = 7
...
# ==========================================
# PALAVRAS-BASE PARA BUSCA DE IMAGEM POR MÓDULO
# ==========================================

PALAVRAS_BASE_IMAGEM = {
    "fundamentos": ["camera settings", "aperture", "shutter speed", "ISO close up"],
    "digital": ["dslr camera", "mirrorless camera", "camera sensor", "photography gear"],
    "analogica": ["film camera", "35mm film", "analog photography", "film roll"],
    "smartphone": ["smartphone photography", "mobile camera", "phone camera lens"],
    "tecnicas": ["studio lighting setup", "photography lighting", "softbox light"],
    "especializacoes": ["macro photography", "wildlife photography", "sports photography"],
    "reviews": ["camera review setup", "lens detail", "photography equipment close up"],
    "video": ["dslr video recording", "camera rig setup", "video lighting setup"],
    "mercado_fotografico": ["new camera launch", "camera store display", "photography expo"]
}

# ==========================================
# MÓDULOS EDITORIAIS (20 TEMAS CADA)
# ==========================================
...
MODULOS_EDITORIAIS = {
    ...
    "fundamentos": [
        ...
        "Entendendo Abertura e Profundidade de Campo",
        "Velocidade do Obturador na Prática",
        "Triângulo da Exposição Explicado",
        "Como Ler o Histograma",
        "O que é Balanço de Branco",
        "Modos da Câmera P, A, S e M",
        "Foco Manual vs Foco Automático",
        "Distância Focal e Seu Impacto na Imagem",
        "O que é Profundidade de Campo",
        "Como Funciona o Fotômetro",
        "RAW vs JPEG: Qual Escolher",
        "O que é Ruído Digital",
        "Entendendo a Nitidez na Fotografia",
        "O Papel da Luz na Formação da Imagem",
        "Como Controlar a Exposição Manualmente",
        "O que é Subexposição e Superexposição",
        "Como Funciona o Obturador da Câmera",
        "Diferença Entre Sensor Full Frame e APS-C",
        "Como Configurar sua Câmera para Iniciantes"
    ],

    "digital": [
        "Mirrorless vs DSLR: Diferenças Reais",
        "Como Escolher Sua Primeira Câmera Digital",
        "Entendendo Sensores CMOS",
        "Megapixels Realmente Importam",
        "Autofoco com Detecção de Olhos",
        "Estabilização de Imagem na Prática",
        "Fotografia em Alta Resolução",
        "Como Atualizar Firmware da Câmera",
        "Câmeras Full Frame para Iniciantes",
        "Câmeras APS-C para Fotógrafos Intermediários",
        "O que é Burst Mode",
        "Fotografia com ISO Alto em Câmeras Modernas",
        "Como Escolher Cartões de Memória",
        "Diferença Entre RAW Comprimido e Não Comprimido",
        "Como Configurar Perfis de Cor",
        "Fotografia Noturna com Câmeras Digitais",
        "Uso de Wi-Fi e Bluetooth na Fotografia",
        "Backup e Organização de Arquivos",
        "Como Prolongar a Vida Útil da Câmera",
        "Erros Comuns ao Usar Câmeras Digitais"
    ],

    "analogica": [
        "Como Funciona o Filme Fotográfico",
        "ISO em Câmeras Analógicas",
        "Tipos de Filme Preto e Branco",
        "Diferença Entre Filme Negativo e Slide",
        "Como Revelar Filme em Casa",
        "Fotometria em Câmeras Antigas",
        "Câmeras Clássicas Icônicas",
        "Grão no Filme Analógico",
        "Como Escolher Filme 35mm",
        "Fotografia Analógica em Luz Natural",
        "Custo Real da Fotografia Analógica",
        "Manutenção de Câmeras Analógicas",
        "Fotografia Analógica vs Digital",
        "Como Armazenar Filmes Fotográficos",
        "Erros Comuns na Revelação",
        "Uso de Lentes Antigas",
        "Exposição Correta no Filme",
        "Fotografia Analógica Artística",
        "Como Digitalizar Negativos",
        "Vale a Pena Fotografar em Filme Hoje"
    ],

    "smartphone": [
        "Modo Manual no Smartphone",
        "Como Usar HDR no Celular",
        "Fotografia Noturna com Smartphone",
        "Lentes Externas para Celular",
        "Apps Profissionais de Edição",
        "Composição com Celular",
        "Controle de ISO no Smartphone",
        "Longa Exposição no Celular",
        "Fotografia de Produto com Celular",
        "Iluminação Caseira para Celular",
        "Como Evitar Fotos Tremidas",
        "Uso de Tripé para Smartphone",
        "Formato RAW no Celular",
        "Edição Profissional no Lightroom Mobile",
        "Erros Comuns na Fotografia Mobile",
        "Gravação de Vídeo Profissional no Celular",
        "Como Fotografar Retratos com Celular",
        "Fotografia de Paisagem com Smartphone",
        "Como Melhorar Nitidez no Celular",
        "Smartphones com Melhor Câmera"
    ],

    "tecnicas": [
        "Esquema de Iluminação com Uma Luz",
        "Luz Rembrandt na Prática",
        "Luz Borboleta para Retratos",
        "Softbox vs Sombrinha",
        "Fotografia de Produto em Estúdio",
        "Controle de Sombras na Fotografia",
        "Golden Hour na Fotografia",
        "Longa Exposição Criativa",
        "Uso de Filtros ND",
        "Fotografia Urbana Profissional",
        "Fotografia de Retrato em Estúdio",
        "Iluminação de Fundo Branco",
        "Como Criar Fundo Preto Dramático",
        "Fotografia com Flash Dedicado",
        "Uso de Rebatedores",
        "Composição Avançada",
        "Regra dos Terços na Prática",
        "Linhas Guias na Composição",
        "Fotografia Minimalista",
        "Fotografia Criativa com Luz Contínua"
    ],

    "especializacoes": [
        "Fotografia Macro Profissional",
        "Microfotografia Explicada",
        "Fotojornalismo Moderno",
        "Fotografia Esportiva",
        "Fotografia de Casamento",
        "Fotografia de Natureza",
        "Fotografia Noturna",
        "Astrofotografia para Iniciantes",
    ...
    "reviews": [
        "Como Avaliar uma Câmera Antes de Comprar",
        "Review Técnico de Lentes 50mm",
        "Filtros UV Valem a Pena",
        "Filtro Polarizador na Prática",
        "Tripés Profissionais",
        "Flashes Dedicados Modernos",
        "Mochilas Fotográficas",
        "Softboxes Portáteis",
        "Ring Light Vale a Pena",
        "Monitores para Fotógrafos",
        "Cartões de Memória de Alta Velocidade",
        "Baterias Originais vs Paralelas",
        "Lentes Prime vs Zoom",
        "Câmeras de Entrada 2026",
        "Câmeras Intermediárias 2026",
        "Melhores Lentes para Retrato",
        "Melhores Lentes para Paisagem",
        "Acessórios Essenciais para Iniciantes",
        "Como Testar Nitidez de Lentes",
        "Equipamentos para Estúdio Caseiro"
    ],

    "video": [
        "Como Gravar Vídeos com DSLR",
        "Perfis de Cor Flat",
        "O que é LUT",
        "Iluminação para Vídeo",
        "Microfones para Criadores",
        "Estabilização para Vídeo",
        "Configuração Ideal para YouTube",
        "Gravação em 4K",
        "Taxa de Quadros Explicada",
        "Slow Motion na Prática",
        "Time Lapse com DSLR",
        "Vídeo com Fundo Desfocado",
        "Edição Básica no DaVinci Resolve",
        "Edição no Premiere Pro",
        "Gravação com Smartphone para YouTube",
        "Iluminação Low Budget",
        "Audio Limpo em Ambientes Internos",
        "Equipamentos para Criadores Iniciantes",
        "Como Fazer B-Roll Profissional",
        "Erros Comuns na Gravação de Vídeo"
    ],

    "mercado_fotografico": [
        "Tendências da Fotografia em 2026",
        "Novos Lançamentos de Câmeras",
        "Evolução das Mirrorless",
        "IA na Fotografia Moderna",
        "Mercado de Equipamentos Usados",
        "Crescimento da Fotografia Mobile",
        "Eventos e Feiras Fotográficas",
        "Valorização da Fotografia Profissional",
        "Como Monetizar com Fotografia",
        "Fotografia como Negócio",
        "Direitos Autorais na Fotografia",
        "Licenciamento de Imagens",
        "Plataformas de Venda de Fotos",
        "Fotografia e Redes Sociais",
        "Algoritmo do Instagram para Fotógrafos",
        "Marketing para Fotógrafos",
        "Branding na Fotografia",
        "Precificação de Serviços Fotográficos",
        "Tendências de Edição",
        "Futuro da Fotografia Digital"
    ]
}
